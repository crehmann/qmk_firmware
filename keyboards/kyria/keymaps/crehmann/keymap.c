...
#define UC_TR1 LT(FUNL, KC_BSPC)
#define UC_TR2 LT(SYMB, KC_ENT)
#define UC_TR3 LT(ADJU, KC_DEL)
...
//  */
     [BASE] = LAYOUT(
       ...
       _______, CH_Y   , RALT_X , KC_C   , KC_V   , KC_B   , _______, _______,   KC_LEAD, _______, KC_N   , KC_M   , KC_COMM, RALT_DT, CH_MINS, _______,
                                  _______, _______, UC_TL1 , UC_TL2 , UC_TL3 ,   UC_TR1, UC_TR2 , UC_TR3 , _______ , _______
     ),
...
//  */
     [MOUR] = LAYOUT(
       ...
       _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______,
                                  _______, _______, _______, KC_LCTL, TG(MOUR),  KC_BSPC, KC_ENT , KC_BTN1, _______, _______
     ),
...
//  */
     [NUMR] = LAYOUT(
       ...
       _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, KC_1   , KC_2   , KC_3   , KC_DOT , _______,
                                  _______, _______, _______, KC_SPC , KC_TAB ,   _______, _______, KC_0   , _______, _______
     ),
...
void ps2_mouse_moved_user(report_mouse_t *mouse_report) {
    if (biton32(layer_state) != MOUR && (abs(mouse_report->x > 5) || abs(mouse_report->y > 5))) {
        layer_move(MOUR);
    }
}
