...
#define UC_UNDO LCTL(KC_Z)
#define UC_REDO LCTL(KC_Y)
...
//  * |      |      | ALGR |      |      |      |                              |      |      |      | ALGR |      |      |
//  * `--------------------+------+------+------+------+------|  |------+------+------+------+------+--------------------'
//  *                      | REC1 | ESC  | SPC  | TAB  | BSPC |  | Lead | ENT  | BSPC | DEL  | PLAY1|
...
//  */
     [BASE] = LAYOUT(
       ...
       _______, CH_Y   , RALT_X , KC_C   , KC_V   , KC_B   , _______, _______,   _______, _______, KC_N   , KC_M   , KC_COMM, RALT_DT, CH_MINS, _______,
                                  DM_REC1, LT(MOUR, KC_ESC) , LT(NAVR, KC_SPC), LT(NUMR, KC_TAB)  , KC_BSPC,   KC_LEAD, LT(FUNL, KC_ENT) , LT(SYMB, KC_BSPC), LT(ADJU, KC_DEL) , DYN_MACRO_PLAY1
     ),
...
//  */
     [NAVR] = LAYOUT(
       _______, _______, _______, _______, _______, _______,                                       UC_UNDO, UC_PSTE, UC_COPY, UC_CUT , UC_UNDO, _______,
       _______, _______, _______, _______, _______, _______,                                       KC_CAPS, KC_LEFT, KC_UP  , KC_DOWN, KC_RGHT, _______,
       _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, KC_INS , KC_HOME, KC_PGUP, KC_PGDN, KC_END , _______,
...
//  */
     [MOUR] = LAYOUT(
       ...
       _______, _______, _______, KC_BTN2, KC_BTN1, _______,                                       _______, _______, KC_WH_U, KC_WH_D, _______, _______,
       _______, _______, UC_CUT , UC_COPY, UC_PSTE, _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______,
...
//  */
    [SYMB] = LAYOUT(
      ...
      _______, CH_PERC, CH_HASH, CH_LBRC, CH_RBRC, CH_TILD, _______, _______,   _______, _______, CH_EURO, CH_EQL , CH_ASTR, _______, CH_MINS, _______,
